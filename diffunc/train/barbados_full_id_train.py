...
# LLsub diffunc/train/barbados_full_id_train.py -g volta:1
...
#     --kill-on-bad-exit=1 \
#     python tools/train_ddpm/barbados_full_id_train.py &> srun_train_barbados_full_id.out&
...
trainer = Trainer(
    ...
    results_folder = 'results/barbados_full_id_train',
